...
<div class="w-full min-h-[calc(100vh-2rem)] flex-1 flex flex-col justify-center items-center py-10 px-4 sm:px-6">
    ...
    <div class="w-full max-w-[440px] bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-xs">
        ...
        <div class="flex flex-col items-center text-center mb-6">
            ...
            <h1 class="text-xl font-bold text-slate-900 tracking-tight">Verify Your Email</h1>
            <p class="text-xs text-slate-500 mt-1 max-w-xs">We sent a 6-digit verification code to your email address. Enter it below to proceed.</p>
        </div>
