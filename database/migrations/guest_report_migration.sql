...
ALTER TABLE `reports`
    ...
    ADD COLUMN `guest_phone` VARCHAR(191) NULL AFTER `guest_name`,
    ADD COLUMN `guest_email` VARCHAR(191) NULL AFTER `guest_phone`,
    ADD COLUMN `reporter_latitude` DECIMAL(10,8) NULL AFTER `guest_email`,
