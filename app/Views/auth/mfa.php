    ...
    <div class="glassmorphism rounded-2xl p-8 max-w-sm w-full shadow-2xl fade-in text-center relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <form action="/brgy-waste-app-v3/public/auth/mfa" method="POST" class="space-y-6">
                ...
                <button type="submit" class="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3 px-4 rounded-lg shadow-md transition">
                    Verify code
                </button>
            </form>

            <div class="mt-6 text-center">
                <p class="text-sm text-muted-foreground">Didn't receive the code? 
                    <a href="/brgy-waste-app-v3/public/auth/mfa?action=resend" class="text-primary font-semibold hover:underline">Resend</a>
                </p>
                <div class="mt-2">
