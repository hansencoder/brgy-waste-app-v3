...
if (isset($_SESSION['user_id'])) {
    if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity'] > 1800)) { // 30 mins
        // We log the timeout
        $db = new Database();
        $db->query("INSERT INTO audit_logs (user_id, action_type, target_entity, action_details, result) VALUES (:user_id, 'Auto Logout', 'Session', 'User logged out due to inactivity', 'success')");
