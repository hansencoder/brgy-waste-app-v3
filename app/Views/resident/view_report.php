    ...
    <main class="max-w-2xl mx-auto px-4 sm:px-6 py-8 md:py-10 flex-1 w-full pb-20">
        ...
        <div class="bg-white rounded-[18px] overflow-hidden shadow-sm border border-gray-200/80 mb-5 flex flex-col">
            ...
            <div class="p-4 space-y-3">
                ...
                <button onclick="copyCoords()" class="w-full text-[12.5px] font-bold text-[#2A523D] hover:text-[#1e3c2c] hover:bg-[#2A523D]/10 px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-1.5" id="copyBtn">
