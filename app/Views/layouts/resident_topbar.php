    ...
    <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-3 lg:hidden">
            ...
            <div class="flex items-center gap-2">
                <div class="h-7 w-7 rounded-full bg-[#083528] flex items-center justify-center overflow-hidden border border-emerald-500/40 shrink-0">
                    <?php if (!empty($topSysLogo)): ?>
                        <img src="<?php echo htmlspecialchars($topSysLogo); ?>" class="h-full w-full object-cover">
                    <?php else: ?>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#10B981]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    <?php endif; ?>
                </div>
                <div class="min-w-0">
                    <p class="text-sm font-extrabold text-slate-900 leading-tight truncate"><?php echo htmlspecialchars($topSysShortName); ?></p>
                </div>
            </div>
        </div>
    </div>
