...
<div class="w-full min-h-[calc(100vh-2rem)] flex-1 flex flex-col justify-center items-center py-10 px-4 sm:px-6">
    ...
    <div class="w-full max-w-[440px] bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-xs">
        ...
        <div class="flex flex-col items-center text-center mb-5">
            ...
            <h1 class="text-lg font-bold text-slate-900 tracking-tight">Two-Factor Authentication</h1>
        ...
        <form action="<?php echo app_url('index.php?url=auth/mfa'); ?>" method="POST" id="mfaForm" class="space-y-5">
        ...
        <div class="mt-5 text-center space-y-2">
            <p class="text-xs text-slate-500 font-normal">
                ...
                <a id="resendLink" href="<?php echo app_url('index.php?url=auth/mfa&action=resend'); ?>" class="font-semibold text-emerald-700 hover:underline">Resend code</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const STORAGE_KEY = 'waste_mfa_resend_expiry';
