                ...
                <div class="space-y-3" id="notifList">
                    <?php if (!empty($notifications)): ?>
                        ...
                        <div class="notif-card bg-white rounded-2xl border <?php echo $isRead ? 'border-slate-200 opacity-90' : 'border-emerald-300 ring-2 ring-emerald-500/10'; ?> shadow-xs p-4 sm:p-5 transition hover:shadow-md flex items-start gap-3.5"
                            ...
                            <div class="w-10 h-10 rounded-xl <?php echo $iconBg; ?> border flex items-center justify-center font-bold text-sm shrink-0 mt-0.5">
                                <?php echo $typeLabel === 'Report Update' ? '📋' : ($typeLabel === 'Announcement' ? '📢' : '🔔'); ?>
                            </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <?php if (!$isRead): ?>
                                    <div class="mt-3 pt-2 border-t border-slate-100 flex justify-end">
                                        <button type="button" onclick="markSingleRead(<?php echo (int)$item['id']; ?>)" class="text-xs font-bold text-emerald-700 hover:text-emerald-900 transition cursor-pointer">
                                            ✓ Mark as read
                                        </button>
                                    </div>
                                <?php endif; ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <div class="bg-white rounded-2xl border border-slate-200 p-12 text-center text-slate-400 text-xs shadow-xs">
