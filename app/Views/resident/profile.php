                ...
                <div class="bg-white border border-gray-200/80 rounded-[20px] p-6 shadow-sm">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-[14px] font-bold text-slate-800">Sign Out</h3>
                                <p class="text-[12px] text-slate-400">Sign out of your CivicLens account</p>
                            </div>
                        </div>
                        <a href="/brgy-waste-app-v3/public/auth/logout" class="bg-red-600 hover:bg-red-700 text-white font-bold px-5 py-2.5 rounded-[10px] text-[13px] shadow-sm shadow-red-600/20 transition-colors">
                            Logout
                        </a>
                    </div>
                </div>
...
<nav class="md:hidden fixed bottom-0 w-full bg-white/95 backdrop-blur-md border-t border-gray-200/60 pt-2.5 pb-6 px-1 z-50 flex justify-between items-end shadow-[0_-10px_20px_rgba(0,0,0,0.03)]">
    ...
    <a href="/brgy-waste-app-v3/public/resident/profile" class="flex flex-col items-center flex-1 pb-1 transform active:scale-95 transition-transform group">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#118B50" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="mb-1"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        <span class="text-[10.5px] font-extrabold tracking-wide text-[#118B50]">Profile</span>
    </a>
</nav>
